...
First, write a function called mapCurrentEvents that maps over the current events object, runs it through
 a constructor function and returns the resulting array.
...
Next, write a function named getCurrentEvents that takes in the request and response as parameters.
 This function should call the mapCurrentEvents function and send the result to the front-end.
...
const reversedString = (str) => {
  return str.split('').reduce((accu, value, i) => {
    accu += str[str.length - 1 - i];
    return accu;
  }, '');
};
