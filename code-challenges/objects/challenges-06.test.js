...
//     var chTemplate = $('#template').html();
//     templateArr.push(Mustache.render(chTemplate,char));
//   });
//   return templateArr;
// };
...
//  from challenge 4, but uses the data's entries instead of its values.
