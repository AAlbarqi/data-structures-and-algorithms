...
//     copy.find('h2').text(person.name);
//     copy.find('h3').text(person.height);
//     copy.find('p').text(person.eye_color);
//     copy.removeAttr('id');
//     $('main').append(copy);
//   });
// }
...
//   let result = [];
//   let ingredients=['G','oa','b','f','p','ch','b','b','c','m','f'];
//   recipe.ingredients.forEach((ingredient, i )=> {
//     result.push(ingredient.slice(ingredient.indexOf(ingredients[i]),ingredient.length));
//   });
//   return result;
// };
