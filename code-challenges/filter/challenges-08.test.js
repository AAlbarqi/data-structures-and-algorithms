...
// Write a function named oddValues that, given an array of integers as input, uses filter to return an array containing
...
// const oddValues = (arr) => {
//   return arr.filter(e => {return (e % 2 === 1)});
// };
...
//   return arr.filter(e => { return e.match(/[aeiuo]/)});
// };
...
//   return arr.filter(e => {return !forbiddenValues.includes(e);})
// };
