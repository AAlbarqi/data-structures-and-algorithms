...
// Without altering the html, write a function named generateSubmitButton that uses jQuery to create
//  a submit button with the text "submit" and append it to the DOM.
// ------------------------------------------------------------------------------------------------ */
...
//   $('body').append(`<button value='submit'>submit</button>`);
// }
...
//   let aTojCities=[];
//   let regex = /^[A-J]/;
//   arr.forEach(city => { if(regex.test(city)){aTojCities.push(city);}});
//   return aTojCities;
// };
